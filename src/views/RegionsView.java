...
public class RegionsView extends javax.swing.JInternalFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (Integer.parseInt(id) == a) {
            JOptionPane.showMessageDialog(this, regionController.update(id, nama));
            
            reset();
            txtId.setEnabled(true);
        } else {
            
            JOptionPane.showMessageDialog(this, regionController.create(id, nama));
            reset();
        }
    ...
    private void txtNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNameKeyTyped
        if (txtName.getText().length() > 25) {
            evt.consume();
            lbl4.setText("Tidak Boleh Lebih 25 Karakter");
        } else {
            lbl4.setText("");
        }
